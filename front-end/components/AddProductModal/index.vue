  ...
  >
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
      ...
      <form @submit.prevent="handleSubmit">
        <div class="mb-4">
          <label class="block font-medium mb-1">Nome do Produto</label>
          <input
            v-model="form.name"
            type="text"
        ...
        <div class="mb-4">
          <label class="block font-medium mb-1">Imagem (opcional)</label>
          <input
...
<script setup>
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      modalStore.closeModal(); // Fecha o modal
      form.value = { name: "", description: "", category: "", image: null }; // Reseta o formulário
    } catch (error) {
